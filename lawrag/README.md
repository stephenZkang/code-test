...
- [x] **v1.0.0**: 基础 RAG 流程、Gemini 集成、Redis 缓存、移动端适配 Web
- [ ] **v1.1.0**: 微信小程序版 (Uni-app / Taro)
- [ ] **v1.2.0**: 手机 App 版 (React Native / Flutter)
- [ ] **v1.3.0**: 用户认证和权限管理、多轮对话上下文记忆
- [ ] **v1.4.0**: 文档分类自动识别、导出对话记录
